<template lang="pug">
el-drawer(title="选择气站", :model-value="modelValue", size="900px", center, @close="handleClose")
  el-form(label-width="5em", inline)
    el-form-item(label="名称")
      el-input(v-model.trim="filter.name")
    el-form-item(label="站点类型")
      el-radio-group(v-model="filter.type", clearable)
        el-radio-button(value="") 全部
        el-radio-button(value="售气站") 售气站
        el-radio-button(value="检测站") 检测站
        el-radio-button(value="充气站") 充气站
    el-form-item
