...
<script setup>
import ComAccountConfig from "./__com__/accountConfig.vue"
import ComContractConfig from "./__com__/contractConfig.vue"
import ComPreviewRaw from "./__com__/rawPreview.vue"

const { fetch, message, router } = inject("global")

const systemConfigList = [
  { name: "账号配置", configId: "accountConfig", com: ComAccountConfig },
  { name: "合同配置", configId: "contractConfig", com: ComContractConfig },
]
