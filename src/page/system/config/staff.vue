...
<script setup>
import ComAddBottleConfig from "./__com__/addBottleConfig.vue"
import ComAddCustomerConfig from "./__com__/addCustomerConfig.vue"
import ComPreviewRaw from "./__com__/rawPreview.vue"

const { fetch, message, router } = inject("global")

const systemConfigList = [
  { name: "客户建档配置", configId: "addCustomerConfig", com: ComAddCustomerConfig },
  { name: "钢瓶建档配置", configId: "addBottleConfig", com: ComAddBottleConfig },
]
